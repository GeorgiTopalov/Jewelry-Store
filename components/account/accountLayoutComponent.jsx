...
const AccountLayout = ({ children }) => {
  ...
  const getCurrentPageName = () => {
    ...
    switch(routeName) {
      ...
      case 'addresses': return 'My Addresses';
      ...
      <div className={styles["dropdown"]}>
        ...
        {isDropdownOpen && (
          <ul className={styles["account-menu"]}>
            <li onClick={() => handleMenuItemClick('profile')} className={styles["profile"]}>
              <h4>Profile</h4>
            </li>
            <li onClick={() => handleMenuItemClick('settings')} className={styles["account-settings"]}>
              <h4>Account Settings</h4>
            </li>
            <li onClick={() => handleMenuItemClick('orders')} className={styles["orders"]}>
              <h4>Orders</h4>
            </li>
            <li onClick={() => handleMenuItemClick('addresses')} className={styles["addresses"]}>
              <h4>Addresses</h4>
            </li>
          </ul>
        )}
